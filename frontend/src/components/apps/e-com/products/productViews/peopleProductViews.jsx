...
//   const renderRandomCategory = () => {
//     const categories = Object.keys(products);
//     const randomIndex = Math.floor(Math.random() * categories.length);
//     const randomCategory = categories[randomIndex];
//     return (
//       <div key={randomCategory}>
//         <Grid container spacing={2}>
//           <Card>
//             <CardContent key={products.id} style={{ padding: "10px" }}>
//               {/* <Typography variant="h5">{randomCategory}</Typography> */}
//               {products[randomCategory]?.map((product) => (
//                 <>
//                   <Grid
//                     item
//                     sm={6}
...
//                   >
//                     <img src={product.image} alt="Seller Image" width="100%" />
...
//   return <div>{renderRandomCategory()}</div>;
// };
